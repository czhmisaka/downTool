...
time.sleep(3)
# for x in range(2000):
a.addMission('https://nchc.dl.sourceforge.net/project/winscp/WinSCP/5.17.5/WinSCP-5.17.5-Setup.exe',fileName='winScp_setup.exe',path='',isLarge=True)
# num = 0
# while num<60:
#     a.statusPrint()
#     time.sleep(1)
