...
a.path = 'C://Users//czhmisaka//Desktop//testFile//Yolov3_pytorch//VOCdevkit//'
# 设置下载路径
a.log = False
a.cmdShow = True
...
a.tick = 0.25
# 终端显示程序的刷新间隔 单位（s）
a.block_size = 1024*10240
a.chunk_size = 1024
# 设置分块下载时的区块大小
a.addMission('http://host.robots.ox.ac.uk/pascal/VOC/voc2007/VOCtrainval_06-Nov-2007.tar',fileName='VOCtrainval_06-Nov-2007.tar',isLarge=True)
a.addMission('http://host.robots.ox.ac.uk/pascal/VOC/voc2012/VOCtrainval_11-May-2012.tar',fileName='VOCtrainval_11-May-2012.tar',isLarge=True)
a.addMission('http://host.robots.ox.ac.uk/pascal/VOC/voc2007/VOCtest_06-Nov-2007.tar',fileName='VOCtest_06-Nov-2007.tar',isLarge=True)
